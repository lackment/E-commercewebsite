        ...
        <div class="container">
          <div class="checkout-addr">
            ...
            <div class="addr-list-wrap">
              <div class="addr-list">
                <ul>
                  <li v-for="(item,index) in addressListFilter" :key="item.addressid" :class="{check:checkedIndex==index}" @click="checkedIndex=index;selectedAddrId=item.addressId">
                    <dl>
                      <dt>{{item.userName}}</dt>
  ...
  export default{
     ...
     data () {
         return {
            limit:3,//默认显示3条数据
            addressList:[],
            checkedIndex:0, //默认选中地址,
            isMdShow:false, //默认不显示弹框
            addressId:"", //删除地址的id
