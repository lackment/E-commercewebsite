<template>
    <div>
        <nav-head></nav-head>
        <nav-bread>Order Confirm</nav-bread>
    ...
    <div class="checkout-order">
      ...
      <div class="order-foot-wrap">
        <div class="prev-btn-wrap">
            <router-link to="/address" class="btn btn--m" tag="button">Previous</router-link>
        </div>
        ...
        methods:{
            init(){
                axios.get("/users/cartList").then((response)=>{
                    ...
                    this.orderTotal = this.shipping + this.subTotal- this.discount + this.tax
                })
            },
            //订单支付
            payment(){
